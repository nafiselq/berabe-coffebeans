<template>
    <section class="relative bg-[url('/img/bg-footer.png')] bg-no-repeat bg-cover bg-center md:h-[492px] flex flex-col justify-center">
        <div class="container mx-auto md:flex md:flex-row flex flex-col justify-between items-start md:p-0 p-[20px]">
            ...
            <!-- <div class="flex flex-col">
                <p class="font-sans text-white text-[26px]">About</p>
                <ul class="mt-[55px] space-y-5">
                    <li class="text-white">Menu</li>
                    <li class="text-white">Features</li>
                    <li class="text-white">News & Blogs</li>
                    <li class="text-white">Help & Supports</li>
                </ul>
            </div> -->
